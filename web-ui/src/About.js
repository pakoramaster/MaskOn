...
useEffect(() => {
  ...
  return (
    <div
      className="min-h-screen flex flex-col justify-center items-center bg-[#18202b]"
    >
        <Nav />
      {/* Header Section */}
        ...
        <div className="w-screen flex justify-center bg-gradient-to-r from-[#202a38] to-[#16202d]">
          <div className="w-full max-w-7xl px-10 py-6 rounded-2xl flex flex-row items-start gap-10">
            <div className="flex-1 flex flex-col items-start">
              <h2 className="text-4xl font-extrabold text-indigo-400 mb-7 tracking-tight">Why MaskOn?</h2>
              <ul className="text-left text-base text-[#e3eaf3] mb-7 w-full pl-4 list-disc font-medium font-sans">
                <li className="mb-2">Runs entirely in your browser – your videos never leave your device.</li>
                <li className="mb-2">No uploads, no waiting, no privacy concerns.</li>
                <li className="mb-2">Instant greenscreen creation for content creators, educators, and more.</li>
              </ul>
              <p className="text-indigo-400 font-semibold mb-8 text-left font-mono">
                Your privacy is our priority. All processing happens locally, and nothing is stored on any server.
              </p>
              <button
